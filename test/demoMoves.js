const  { SpriteManager, RazorLeafAnimator, Trainer, Pokemon, TextBox, BattleLayoutDirector, RenderService, BattleLayoutBuilder } = require("../dist");
...
(async () => {
  ...
  const razorLeaf = new RazorLeafAnimator(manager, 0, attackerRect, defenderRect);
